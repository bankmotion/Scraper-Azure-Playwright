...
export const randomPause = async (page: Page, min: number = 1.5, max: number = 2.5): Promise<void> => {
...
export const streamToBuffer = async (readableStream: NodeJS.ReadableStream | null): Promise<Buffer> => {
  const chunks: Buffer[] = [];
